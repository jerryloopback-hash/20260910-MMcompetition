...
用法: python m6_analysis.py [days]      # days=分析天数(默认 306 全窗); 产物 p3/m6_out/
"""
import sys
import time
...
def execute_plan(P, D, pv, ld, soc0, lam):
    ...
    调度次序与 m5_solve.execute_realized 一致(购电优先供载→光伏→放电→缺口兜底),
